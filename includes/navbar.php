...
<nav class="tw-fixed tw-top-0 tw-w-full tw-z-[1000] tw-bg-white/80 tw-backdrop-blur-xl tw-shadow-md tw-h-20">
  <div class="tw-flex tw-justify-between tw-items-center tw-h-full tw-px-8 tw-max-w-7xl tw-mx-auto tw-font-headline tw-antialiased">
    ...
    <div class="tw-flex tw-items-center tw-gap-4">
      <a class="btn btn-primary btn-sm px-3 rounded-pill" href="<?= url('/auth/login') ?>">Đăng nhập</a>
      <?php if ($activePage !== 'ket-qua'): ?>
        <a href="<?= url('/ket-qua') ?>" class="tw-hidden md:tw-inline-flex tw-items-center tw-justify-center tw-text-center tw-bg-amber-700 tw-text-white hover:tw-bg-amber-800 tw-px-4 tw-py-[0.3rem] tw-rounded-full tw-font-semibold tw-text-sm tw-leading-[1.6] tw-transition-all tw-no-underline">
          Tra cứu
        </a>
      <?php endif; ?>
    </div>
